...
import com.stone.Lsqnl.adapter.MineListAdapter;
...
public class MineActivity extends Activity implements OnItemClickListener{
	...
	private String[] aboutItemNames = {"通知中心",  "推荐给朋友", "退出账号"};
	...
	public void onItemClick(AdapterView<?> parent, View view, int position,
		...
		if(parent.getId() == R.id.lv_mine_about) {
			...
			case 1:		//推荐给朋友
				...
				toShare.putExtra(Intent.EXTRA_TEXT, "老师去哪儿了" +"\n" + "针对铁大的老师去哪了测试版上线了，赶紧下载体验吧"
						+ "http://lsqnl.bmob.cn/");
